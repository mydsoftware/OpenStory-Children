import type { ImageProvider, LLMProvider, ProviderMetadata } from "./providers.js";

type OllamaConfig = { baseUrl: string; model: string; timeoutMs?: number };
type OpenAIConfig = { baseUrl: string; model: string; timeoutMs?: number; apiKey?: string };
type ComfyConfig = { baseUrl: string; workflow?: Record<string, unknown>; timeoutMs?: number; pollIntervalMs?: number };
